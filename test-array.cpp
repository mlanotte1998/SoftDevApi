...
void test_bool_array() {
    ...
    a1->push_back(true);
    t_true(a1->getLength() == 1);
    t_true(a1->get(0)->equals(true));
    a1->push_back(false);
    t_true(a1->get(0)->equals(true));
    t_true(a1->get(1)->equals(false));
    t_true(a1->getLength() == 2);
    a1->push_front(true);
    t_true(a1->get(0)->equals(true));
    t_true(a1->get(1)->equals(true));
    t_true(a1->get(2)->equals(false));
    t_true(a1->getLength() == 3);
    a1->remove(2);
    t_true(a1->get(0)->equals(true));
    t_true(a1->get(1)->equals(true));
    ...
    t_true(a1->get(1)->equals(true));
    t_true(a1->get(2)->equals(false));
    t_true(a1->get(3)->equals(false));
    t_true(a1->get(4)->equals(true));
    t_true(a1->getLength() == 5);
...
void test_int_array() {
    ...
    a1->push_back(50);
    t_true(a1->getLength() == 1);
    t_true(a1->get(0)->equals(50));
    a1->push_back(20);
    t_true(a1->get(0)->equals(50));
    t_true(a1->get(1)->equals(20));
    t_true(a1->getLength() == 2);
    a1->push_front(70);
    t_true(a1->get(0)->equals(70));
    t_true(a1->get(1)->equals(50));
    t_true(a1->get(2)->equals(20));
    t_true(a1->getLength() == 3);
    a1->remove(1);
    t_true(a1->get(0)->equals(70));
    t_true(a1->get(1)->equals(20));
    ...
    a1->update(30, 1);
    t_true(a1->get(0)->equals(70));
    t_true(a1->get(1)->equals(30));
    t_true(a1->getLength() == 2);
    a1->insert(5, 0);
    t_true(a1->get(0)->equals(5));
    t_true(a1->get(1)->equals(70));
    t_true(a1->get(2)->equals(30));
    t_true(a1->getLength() == 3);
    ...
    t_true(a1->get(1)->equals(70));
    t_true(a1->get(2)->equals(30));
    t_true(a1->get(3)->equals(10));
    t_true(a1->get(4)->equals(90));
    t_true(a1->getLength() == 5);
    t_false(a1->equals(a2));
    t_true(a1->equals(a2));
...
void test_float_array() {
    ...
    a1->push_back(50.5);
    t_true(a1->getLength() == 1);
    t_true(a1->get(0)->equals(50.5));
    a1->push_back(20);
    t_true(a1->get(0)->equals(50.5));
    t_true(a1->get(1)->equals(20));
    t_true(a1->getLength() == 2);
    a1->push_front(70.1);
    t_true(a1->get(0)->equals(70.1));
    t_true(a1->get(1)->equals(50.5));
    t_true(a1->get(2)->equals(20));
    t_true(a1->getLength() == 3);
    a1->remove(1);
    t_true(a1->get(0)->equals(70.1));
    ...
    a1->update(30.45, 1);
    t_true(a1->get(0)->equals(70.1));
    t_true(a1->get(1)->equals(30.45));
    t_true(a1->getLength() == 2);
    a1->insert(5.999, 0);
    t_true(a1->get(0)->equals(5.999));
    t_true(a1->get(1)->equals(70.1));
    t_true(a1->get(2)->equals(30.45));
    t_true(a1->getLength() == 3);
    IntArray *a2 = new IntArray();
    a2->push_back(10.2);
    ...
    t_true(a1->get(1)->equals(70.1));
    t_true(a1->get(2)->equals(30.45));
    t_true(a1->get(3)->equals(10.2));
    t_true(a1->get(4)->equals(90.12345));
    t_true(a1->getLength() == 5);
    t_false(a1->equals(a2));
    t_true(a1->equals(a2));
